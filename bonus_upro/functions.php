...
function load_style_script(){
    ...
    wp_enqueue_script('my-add', get_stylesheet_directory_uri() . '/assets/js/add.js', array(), false, true);
}


/*add_action('acf/input/admin_enqueue_scripts', 'my_acf_enqueue_script');
function my_acf_enqueue_script() {
    wp_enqueue_script('acf-category-filter', get_template_directory_uri() . '/assets/js/acf-category-filter.js', array('jquery'), null, true);
}*/

<div class="card-v2">
	<div class="card-v2__head img-center">
		<?php the_post_thumbnail('full') ?>
	</div>
	<div class="card-v2__body">

		<?php if ($field = get_field('off')): ?>
			<div class="card-v2__title"><?= $field ?></div>
		<?php endif ?>
		
		<div class="card-v2__text last-no-margin">
			...
			<a href="<?php the_permalink() ?>">
				<?php _e('More', 'Bonus') ?> <?php the_title() ?> <?php _e('coupons', 'Bonus') ?>
			</a>
		</div>

		<?php if (get_field('is_verified')): ?>
			<div class="card-v2__status">
				<img src="<?= get_stylesheet_directory_uri() ?>/assets/icons/check-circle-gradient.svg" alt="">
				<?php _e('Verified', 'Bonus') ?>
			</div>
		<?php endif ?>
		
		<div class="card-v2__btn-slot">
			<a href="#popup-promo-code-<?= get_the_ID() ?>" data-action="open-popup" class="btn-secondary default-gradient">
				<?php _e('Shop with code', 'Bonus') ?>
			</a>
		</div>
	</div>
</div>

<div class="popup" id="popup-promo-code-<?= get_the_ID() ?>">
	<div class="popup__body">
		<div class="popup__content">
			...
			<div class="promo-code-popup">
				...
				<?php if ($field = get_field('popup_text')): ?>
